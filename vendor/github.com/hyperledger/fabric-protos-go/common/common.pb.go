...
type Envelope struct {
	...
	Signature []byte `protobuf:"bytes,2,opt,name=signature,proto3" json:"signature,omitempty"`
	// PreImage space for redaction
	PreImages            [][]byte `protobuf:"bytes,3,rep,name=pre_images,json=preImages,proto3" json:"pre_images,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *Envelope) GetPreImages() [][]byte {
	if m != nil {
		return m.PreImages
	}
	return nil
...
type BlockData struct {
	...
	PreimageSpace        [][]byte `protobuf:"bytes,2,rep,name=preimage_space,json=preimageSpace,proto3" json:"preimage_space,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *BlockData) GetPreimageSpace() [][]byte {
	if m != nil {
...
var fileDescriptor_8f954d82c0b891f6 = []byte{
	...
	,
}

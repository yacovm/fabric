...
func TestValidateBlock(t *testing.T) {
	...
	// Prepare a valid block.
	// Move all kvwrites to pre-image space.
	preImages := make(chan []byte, 100)
	forEachTransaction(block, func(block *common.Block, i int, rws *rwsetutil.TxRwSet) {
		for _, nsrws := range rws.NsRwSets {
			for _, kvWrite := range nsrws.KvRwSet.Writes {
				kvWrite.ValueHash = hash(kvWrite.Value)
				preImages <- kvWrite.Value
				kvWrite.Value = nil
			}
		}
	...
	for preImage := range preImages {
		block.Data.PreimageSpace = append(block.Data.PreimageSpace, preImage)
	}
...
func TestValidateBlockInvalid(t *testing.T) {
	rawBlock := ``
	blockBytes, err := base64.StdEncoding.DecodeString(rawBlock)
	assert.NoError(t, err)
	...
	forEachTransaction(block, func(block *common.Block, i int, rws *rwsetutil.TxRwSet) {
		for _, nsrws := range rws.NsRwSets {
			for _, kvWrite := range nsrws.KvRwSet.Writes {
				kvWrite.ValueHash = hash(kvWrite.Value)
				kvWrite.ValueHash = append(kvWrite.ValueHash, byte(1))
				preImages <- kvWrite.Value
				kvWrite.Value = nil
			}
		}

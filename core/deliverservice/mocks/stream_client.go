...
func (_m *StreamClient) Close() {
	_m.Called()
}

// Disconnect provides a mock function with given fields:
func (_m *StreamClient) Disconnect() {
	_m.Called()
}

// GetEndpoint provides a mock function with given fields:
func (_m *StreamClient) GetEndpoint() string {
	ret := _m.Called()
...
func (_m *StreamClient) Recv() (*orderer.DeliverResponse, error) {
	ret := _m.Called()
...
func (_m *StreamClient) Send(_a0 *common.Envelope) error {
	ret := _m.Called(_a0)
...
func (_m *StreamClient) UpdateEndpoints(endpoints []comm.EndpointCriteria) {
	_m.Called(endpoints)
}

// UpdateReceived provides a mock function with given fields: blockNumber
func (_m *StreamClient) UpdateReceived(blockNumber uint64) {

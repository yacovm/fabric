...
type CommitteeFeedback struct {
	Suspects             []uint64 `protobuf:"varint,1,rep,packed,name=suspects,proto3" json:"suspects,omitempty"`
...
func (m *CommitteeFeedback) GetSuspects() []uint64 {
	if m != nil {
		return m.Suspects
	}
	return nil
...
var fileDescriptor_5339e81cc9997a76 = []byte{
	...
	0x10, 0x46, 0xf9, 0xf9, 0x45, 0x96, 0x74, 0x6e, 0x25, 0x56, 0x8b, 0x95, 0xd5, 0x4c, 0x21, 0x5e,
	...
	0x97, 0x2f, 0xb0, 0x7f, 0x06, 0x00, 0x00, 0xff, 0xff, 0x6d, 0x42, 0x69, 0x06, 0xce, 0x00, 0x00,
	0x00,
}

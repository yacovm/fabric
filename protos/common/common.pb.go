...
type MetadataSignature struct {
	...
	CommitteeAuxiliaryInput []byte   `protobuf:"bytes,6,opt,name=committee_auxiliary_input,json=committeeAuxiliaryInput,proto3" json:"committee_auxiliary_input,omitempty"`
	XXX_NoUnkeyedLiteral    struct{} `json:"-"`
	XXX_unrecognized        []byte   `json:"-"`
	XXX_sizecache           int32    `json:"-"`
}
...
func (m *MetadataSignature) GetCommitteeAuxiliaryInput() []byte {
	if m != nil {
		return m.CommitteeAuxiliaryInput
	}
	return nil
}
...
type OrdererBlockMetadata struct {
	...
	HeartbeatSuspects    []int32     `protobuf:"varint,5,rep,packed,name=heartbeat_suspects,json=heartbeatSuspects,proto3" json:"heartbeat_suspects,omitempty"`
	XXX_NoUnkeyedLiteral struct{}    `json:"-"`
	XXX_unrecognized     []byte      `json:"-"`
	XXX_sizecache        int32       `json:"-"`
}
...
func (m *OrdererBlockMetadata) GetHeartbeatSuspects() []int32 {
	if m != nil {
		return m.HeartbeatSuspects
	}
	return nil
}
...
var fileDescriptor_8f954d82c0b891f6 = []byte{
	...
	,
}

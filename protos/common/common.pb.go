...
func (Status) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_common_d96a2bf8d827aee6, []int{0}
}
...
func (HeaderType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_common_d96a2bf8d827aee6, []int{1}
}
...
func (BlockMetadataIndex) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_common_d96a2bf8d827aee6, []int{2}
}
...
func (*Header) Descriptor() ([]byte, []int) {
	return fileDescriptor_common_d96a2bf8d827aee6, []int{3}
}
...
func (*ChannelHeader) Descriptor() ([]byte, []int) {
	return fileDescriptor_common_d96a2bf8d827aee6, []int{4}
}
...
func (*SignatureHeader) Descriptor() ([]byte, []int) {
	return fileDescriptor_common_d96a2bf8d827aee6, []int{5}
}
...
func (*Payload) Descriptor() ([]byte, []int) {
	return fileDescriptor_common_d96a2bf8d827aee6, []int{6}
}
...
func (*Envelope) Descriptor() ([]byte, []int) {
	return fileDescriptor_common_d96a2bf8d827aee6, []int{7}
}
...
func (*Block) Descriptor() ([]byte, []int) {
	return fileDescriptor_common_d96a2bf8d827aee6, []int{8}
}
...
func (*BlockHeader) Descriptor() ([]byte, []int) {
	return fileDescriptor_common_d96a2bf8d827aee6, []int{9}
}
...
func (*BlockData) Descriptor() ([]byte, []int) {
	return fileDescriptor_common_d96a2bf8d827aee6, []int{10}
}
...
func (*BlockMetadata) Descriptor() ([]byte, []int) {
	return fileDescriptor_common_d96a2bf8d827aee6, []int{11}
}
...
type OrdererBlockMetadata struct {
	...
	CommittteeCommitment []byte      `protobuf:"bytes,4,opt,name=committtee_commitment,json=committteeCommitment,proto3" json:"committtee_commitment,omitempty"`
	XXX_NoUnkeyedLiteral struct{}    `json:"-"`
	XXX_unrecognized     []byte      `json:"-"`
	XXX_sizecache        int32       `json:"-"`
}
...
func (*OrdererBlockMetadata) Descriptor() ([]byte, []int) {
	return fileDescriptor_common_d96a2bf8d827aee6, []int{12}
}
...
func (m *OrdererBlockMetadata) GetCommittteeCommitment() []byte {
	if m != nil {
		return m.CommittteeCommitment
	}
	return nil
}
...
func init() { proto.RegisterFile("common/common.proto", fileDescriptor_common_d96a2bf8d827aee6) }

var fileDescriptor_common_d96a2bf8d827aee6 = []byte{
	// 1101 bytes of a gzipped FileDescriptorProto
	,
}
